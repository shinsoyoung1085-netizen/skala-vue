...
<template>
  <div class="umbrella-view">
    ...
    <BaseDashboardCard title="위치 설정">
      ...
      <transition name="wx-alert-fade">
        <div
          v-if="locationStatus"
          class="wx-alert"
          :class="`wx-alert--${locationStatusType}`"
        >
    ...
    <BaseDashboardCard title="외출 감지">
      ...
      <el-button
        type="warning"
        class="indoor-full-btn secondary"
        @click="triggerLeaveToast"
      >
        🚪 외출 감지 수동 시뮬레이션
      </el-button>
    </BaseDashboardCard>
